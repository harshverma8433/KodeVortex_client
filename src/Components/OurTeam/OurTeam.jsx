...
const TeamShowcase = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-black via-slate-900 to-black py-16 md:py-24 overflow-hidden">
      ...
      >
        <h2 className="text-white text-lg uppercase tracking-widest mb-2 font-light">The DEVELOPERS</h2>
        ...
        <p className="text-gray-400 mt-4 max-w-xl mx-auto">Extraordinary talents coming together to create exceptional experiences</p>
      </motion.div>
        ...
        <Slider {...settings} className="team-slider">
          {teams.map((member, index) => (
            <div key={index} className="px-3 md:px-4 py-2">
              <motion.div
                className={`relative group overflow-hidden ${activeSlide === index ? 'active-slide' : ''}`}
