...
const Footer = () => {
  ...
  const contactLinks = [
    ...
    { href: "https://www.linkedin.com/company/kodevortex", label: "LinkedIn", icon: "🔗" },
    { href: "https://www.instagram.com/kodevortex", label: "Instagram", icon: "📸" },
    { href: "https://twitter.com/kodeVortex", label: "Twitter (X)", icon: "🐦" }
  ];

  return (
    <footer className="bg-gradient-to-b bg-[#181739] text-white pt-10 px-4 transition-all duration-700 ease-in-out opacity-0 translate-y-10">
  ...
  />
        ...
        <div className="flex flex-wrap lg:px-24 justify-center sm:justify-between gap-12 text-center sm:text-left">
          ...
          <div className="w-full sm:w-auto flex flex-col items-center justify-center mb-9">
            ...
            <p className="text-gray-400 mt-4 max-w-xs text-center text-sm">
              Empowering innovation through code. Dive into the vortex of knowledge.
            </p>
          </div>

          {/* KVTech Section with hover effects */}
          <div className="flex flex-col space-y-3 text-center sm:text-left">
            <h3 className="font-bold text-2xl mb-2 text-[#056777]">KodeVortex</h3>
            {navLinks.map((link, index) => (
              ...
              >
                <span className="mr-2 opacity-0 transition-all duration-200 group-hover:opacity-100">›</span>
                {link.label}
              </Link>
            ))}
          </div>
          ...
          <div className="flex flex-col space-y-4 text-center sm:text-left w-full sm:w-auto max-w-xs">
            <h3 className="font-bold text-2xl mb-2 text-[#056777]">Join Our Newsletter</h3>
            <p className="text-sm text-gray-300 mb-2">Stay updated with our latest news and offers</p>
        ...
        <div className="mt-16 border-t border-gray-800 pt-6 pb-8">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
            <span className="text-gray-400">© {year} KodeVortex. All rights reserved.</span>
            ...
            <Link to="/privacy-policy" className="text-gray-400 hover:text-[#056777] text-sm">Privacy Policy</Link>
            <Link to="/terms" className="text-gray-400 hover:text-[#056777] text-sm">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
