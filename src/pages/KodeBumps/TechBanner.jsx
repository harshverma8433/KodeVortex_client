  ...
  return (
    <div className="relative flex justify-center items-center mt-20 px-4 sm:px-6 md:px-10">
      ...
      <motion.div
        ...
        viewport={{ amount: 0.2 }}
        className="relative bg-black space-y-6 text-white flex flex-col xl:flex-row justify-center items-center border border-slate-500 p-6 sm:p-8 md:p-10  md:space-y-0 md:space-x-10 rounded-xl shadow-lg w-[85%] h-auto md:h-96"
      >
        {/* Left Content */}
        <motion.div
          className="flex flex-col  xl:ml-24 ml-0 space-y-4 sm:space-y-6 text-center md:text-left"
        ...
        <motion.div
          ...
          viewport={{ amount: 0.2 }}
          className="w-full   py-6  xl:py-0  flex justify-center    xl:justify-center"
        >
          <motion.button
