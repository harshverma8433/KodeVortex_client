...
const Lakshyarithm = () => {
  ...
  const techItems = [
    ...
    { name: "Advanced Python", icon: "⚙️", description: "Professional-grade programming techniques and libraries", color: "from-indigo-600 to-blue-500" },
    ...
    { name: "MERN Stack", icon: "⚛️", description: "Modern web development with MongoDB, Express, React, and Node.js", color: "from-cyan-500 to-teal-400" },
